...
## Conclusion
In this chapter we discussed the components that make up the content pipeline, how they work together to compile assets, and the benefits of using the content pipeline. Now that we've covered the foundational topics of MonoGame, in the next chapter we'll start designing the game we're going to make and create the initial project structure.
